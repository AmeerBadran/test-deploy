...
const DoctorForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      phone: Yup.string().matches(/^\d+$/, 'Phone number must contain only digits').required('Phone number is required').min(10,'Phone number must have 10 numbers').max(10,'Phone number must have 10 numbers'),
